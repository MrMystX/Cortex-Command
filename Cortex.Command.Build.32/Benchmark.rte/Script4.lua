...
-- Start Activity
-----------------------------------------------------------------------------------------
function Benchmark4:StartActivity()
	print ("Benchmark4:StartActivity");
	...
	self.Benchmark4Timer = Timer();
	self.Benchmark4Timer:Reset();
...
--
-----------------------------------------------------------------------------------------
function Benchmark4:SpawnActor(pos, flipped)
	local actor = nil;
...
-- Pause Activity
-----------------------------------------------------------------------------------------
function Benchmark4:PauseActivity(pause)
end
-----------------------------------------------------------------------------------------
-- End Activity
-----------------------------------------------------------------------------------------
function Benchmark4:EndActivity()
end
-----------------------------------------------------------------------------------------
-- Update Activity
-----------------------------------------------------------------------------------------
function Benchmark4:UpdateActivity()
	...
	if self.GenericTimer:IsPastSimMS(self.StartTime) and not self.GenericTimer:IsPastSimMS(self.StartTime + self.Length) then
		...
		if self.FrameCount > 0 then
			local frametime = self.Benchmark4Timer.ElapsedRealTimeMS - self.LastFrameTime
			self.LastFrameTime = self.Benchmark4Timer.ElapsedRealTimeMS
